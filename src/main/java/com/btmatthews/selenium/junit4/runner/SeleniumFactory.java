...
public interface SeleniumFactory<T> {
     ...
     * @throws Exception IF there was an problem creating the object.
     */
     ...
     * the tests.
     *
     * @param object The object used to communicate with the Selenium Server or Web
     *               Browser.
     * @throws Exception If there was a problem connecting to the Selenium Server or
     ...
     * @param object The object used to communicate with the Selenium Server or Web
     *               Browser.
     * @throws Exception If there was a problem disconnecting from the Selenium Server
